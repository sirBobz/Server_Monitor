...
class africaTalking extends Core {
	// =========================================================================
	// [ Fields ]
	// =========================================================================
	public $gateway = 1;
	...
	public function sendSMS($message) {
		...
		//example: http://api.africastalking.com/version1/messaging?user=XXXXXX&password=PASSWORD&api_id=111111&to=11111111&text=Message
