...
$sm_lang = array(
	...
	'notifications' => array(
		...
		'off_email_body' => "Failed to connect to the following server:<br/><br/>Server: %LABEL%<br/>IP: %IP%<br/>Port: %PORT%<br/>Error: %ERROR%<br/>Date: %DATE% <br/><br/> <b>Please Call and Inform the Support Team Soonest</b>",
